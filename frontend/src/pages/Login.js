  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div className="signup-container">
        ...
        <input className="input-field" id="email-input" type='email' value={email} onChange={(e) => setEmail(e.target.value)} />

        <label className="input-label" htmlFor="password-input"> Password </label>
        <input className="input-field" id="password-input" type='password' alue={password} onChange={(e) => setPassword(e.target.value)} />
